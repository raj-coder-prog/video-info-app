...
def download_video():
    ...
    try:
        ...
        <body style="font-family: sans-serif; text-align: center; padding: 50px; background: #f4f4f9;">
            <div style="background: white; padding: 30px; border-radius: 12px; display: inline-block; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
                <h1 style="color: #00875a; margin-bottom: 10px;">🎉 Success!</h1>
                <p style="font-size: 16px; color: #444;">Video saved straight into your custom storage folder:</p>
                <code style="display: block; background: #f1f5f9; padding: 10px; border-radius: 6px; margin: 10px 0; color: #334155; font-size: 13px;">{DOWNLOAD_FOLDER}</code>
                <p style="font-size: 14px; color: #777;">Open your phone's 'Files by Google' viewer app to watch it.</p>
                <br>
                <a href="/" style="padding: 10px 20px; background: #ff0000; color: white; text-decoration: none; border-radius: 6px; font-weight: bold;">Go Back Dashboard</a>
            </div>
        </body>
        """
